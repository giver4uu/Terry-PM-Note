...
**작성자:** Terry
**버전:** v1.0.0
**상태:** ✅ 완료 - Week 5 Day 1-4 완료 (9/9 개념 완성, DCQ 8/8 커버 100%)
...
| C-009 | Application | Candidate Journey | P1 | Medium | Low | 7순위 | ✅ 완료 |
| **C-010** | **Interview Stage** | Candidate Journey | **P0** | High | Medium | 5순위 | ✅ 완료 |
| **C-011** | **Lead Time** | Candidate Journey | **P0** | **Critical** | Low | 2순위 | ✅ 완료 |
| C-012 | Interview | Evaluation | P0 | High | Medium | 6순위 | ✅ 완료 |
| **C-013** | **Evaluation Record** | Evaluation | **P0** | **Critical** | Medium | 3순위 | ✅ 완료 |
| **C-014** | **Competency Assessment** | Evaluation | **P0** | **Critical** | Medium | 4순위 | ✅ 완료 |
| C-015 | Interviewer | Evaluation | P1 | High | Low | 8순위 | ✅ 완료 |
...
### Day 3-4: P0 개념 3개 + P1 개념 2개 ✅ 완료

**작성 완료:**
5. ✅ **Interview Stage** (C-010) - 전형 단계 정의 | [문서](./dynamic/c-010-interview-stage.md)
6. ✅ **Interview** (C-012) - 면접 이벤트 | [문서](./dynamic/c-012-interview.md)
7. ✅ **Competency Assessment** (C-014) - 역량 종합 평가, DCQ-05~07 핵심 | [문서](./dynamic/c-014-competency-assessment.md)
8. ✅ **Application** (C-009) - 지원 행위 | [문서](./dynamic/c-009-application.md)
9. ✅ **Interviewer** (C-015) - 면접관 패턴 분석, DCQ-04 | [문서](./dynamic/c-015-interviewer.md)

**산출물:**
- 개념 문서 5개 (총 약 2,000줄)
- C-014: 집계 로직, 동적 기준점 계산 알고리즘
- C-015: 면접관 익명화 레벨 2가지 옵션 제시
- DCQ 쿼리 로직 15개 추가 (SQL 포함)
- 실제 사례 예시 10건 (합격/탈락/면접관 패턴/캘리브레이션)
- 관계 다이어그램 5개
...
| 2025-11-28 Day 3-4 | Week 5 Day 3-4 완료, v1.0.0 릴리즈 (9/9 완성) | Terry | C-010, C-012, C-014, C-009, C-015 작성 완료, DCQ 커버리지 100% 달성, 동적 개념 전체 완성 |
